...
Partial Public Class LibraryManagementDBEntities
    Inherits DbContext

    Public Sub New()
        MyBase.New("name=LibraryManagementDBEntities")
    End Sub
    ...
    Public Overridable Property BorrowDetails() As DbSet(Of BorrowDetail)
    Public Overridable Property BorrowTickets() As DbSet(Of BorrowTicket)
    Public Overridable Property Categories() As DbSet(Of Category)
    Public Overridable Property Deposits() As DbSet(Of Deposit)
    Public Overridable Property Payments() As DbSet(Of Payment)
    Public Overridable Property Publishers() As DbSet(Of Publisher)
