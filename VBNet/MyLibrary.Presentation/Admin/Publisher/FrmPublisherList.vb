...
Public Class FrmPublisherList
    Private ReadOnly _publisherService As PublisherService
    ...
    Public Sub New()
        ...
        Dim config As New MapperConfiguration(Sub(cfg)
                                                  cfg.AddProfile(New PublisherMappingProfile())
                                              End Sub)
        Dim mapper As IMapper = config.CreateMapper()
        Dim uow As New UnitOfWork()
        _publisherService = New PublisherService(uow, mapper)
        _cloudinaryService = New CloudinaryService
        _bookService = New BookService(uow, mapper)
    End Sub

    Private Sub FrmPublisherList_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        SetupGrid()
        LoadData()
    End Sub
    ...
    Private Sub SetupGrid()
        ...
        dgvCategories.Columns.Add("PublisherName", "Tên Nhà xuất bản")
        dgvCategories.Columns("PublisherName").DataPropertyName = "PublisherName"
    ...
    Private Async Sub LoadData()
        Try
            Dim result = Await _publisherService.GetPagedAsync(txtSearch.Text.Trim(), _currentPage, _pageSize)
    ...
    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        Using frm As New FrmPublisherEditor(0, _publisherService, _cloudinaryService)
    ...
    Private Sub btnEdit_Click(sender As Object, e As EventArgs) Handles btnEdit.Click
        ...
        Using frm As New FrmPublisherEditor(id, _publisherService, _cloudinaryService)
            If frm.ShowDialog() = DialogResult.OK Then
                LoadData()
            End If
        End Using
    ...
    Private Async Sub btnDelete_Click(sender As Object, e As EventArgs) Handles btnDelete.Click
        ...
        If MessageBox.Show("Bạn có chắc chắn muốn xóa Nhà xuất bản này?", "Cảnh báo",
    ...
    Private Sub btnDetail_Click(sender As Object, e As EventArgs) Handles btnDetail.Click
        ...
        Using frm As New FrmPublisherDetail(id, _publisherService, _bookService)
            frm.ShowDialog()
        End Using
    End Sub
    ...
    Private Function GetSelectedId() As Integer
        If dgvCategories.SelectedRows.Count = 0 Then
            MessageBox.Show("Vui lòng chọn một Nhà xuất bản trong danh sách.")
            Return 0
        End If
