        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SlotCode = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxPricePerDay = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ParkingFeeRules", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ParkingFeeRules_VehicleTypes_VehicleTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ParkingFeeRules_VehicleTypeId",
                table: "ParkingFeeRules",
